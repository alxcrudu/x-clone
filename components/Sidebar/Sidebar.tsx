...
const Sidebar: React.FC<ISidebarProps> = async ({ session }) => {
  ...
  return (
    <div className="paddings fixed bottom-0 z-50 flex w-screen justify-center border-neutral-800 bg-black md:sticky md:top-0 md:max-h-screen md:w-fit md:flex-col md:items-center md:justify-between">
